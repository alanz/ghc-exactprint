...
In the ghc-exactprint directory
    ...
    $ mkdir tests/examples/ghc1001-copied
    $ find /tmp/ghc-tests -iname "*.hs"  | xargs cp  --backup=numbered -t ./tests/examples/ghc1001-copied/
...
See http://manpages.ubuntu.com/manpages/zesty/en/man1/mmv.1.html
    ...
    $ cd tests/examples/ghc1001-copied
    $ mmv "*.hs.~*~" "#1.#2.hs"
