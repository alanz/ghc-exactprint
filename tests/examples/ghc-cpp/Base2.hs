-- From ./hackage-roundtrip-work/dph-lifted-copy-0.7.0.1/Data/Array/Parallel/PArray/Base.hs
-- I think pragma collection with GHC_CPP fails becauseof the #include before the module def
