...
--   setAnnotationAnchor x anc cs = x { ddwc_an = setAnchorEpa (ddwc_an x) anc cs }
...
applyComment c
  = modify (\s -> s { epCommentsApplied = c:(epCommentsApplied s) } )
